...
public class TestController {
    ...
    @GetMapping("")
    public Mono<String> home() throws UnknownHostException{
        String hostName = InetAddress.getLocalHost().getHostName();
        return Mono.just(String.format("Arca Cotizador Service - Reactive with WebFlux! %s on port %s", hostName, port))
